...
```sh
git clone https://github.com/foo/dummy-nomad-plugin.git
cd dummy-nomad-plugin
...
| Name | E-mail     |
|------|------------|
| Juan David Salamanca | [juan.salamanca@physik.hu-berlin.de](mailto:juan.salamanca@physik.hu-berlin.de)
